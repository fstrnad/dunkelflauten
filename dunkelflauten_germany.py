...
savepath = f'{config['plot_dir']}/dunkelflauten_era5/cf_ts_{df_type}_dunkelflauten_{country_name}_era5_{gs}.png'
...
savepath = f'{config['plot_dir']}/dunkelflauten_local_{country_name}_era5_{gs}.png'
